...
curl -s -o /etc/NetworkManager/NetworkManager.conf https://gist.githubusercontent.com/fsg-gitbot/e1067620c0f45e3c082aa70255075afa/raw/k8s-NetworkManager.conf
